...
(deftest test-deeply-nested-conditionals
  (is (= [{:type       :if
           ...
           :when-true  {:type       :if
                        :condition  [:user :has_permissions]
                        :when-true  [{:type :text :value "Admin Panel: "}
                                     {:type :value-node :value [:user :name]}]
                        :when-false {:type :text :value "Access Denied - No Permissions"}}
           :when-false {:type       :if
                        :condition  [:user :is_logged_in]
                        :when-true  [{:type :text :value "Welcome "}
                                     {:type :value-node :value [:user :name]}
                                     {:type :text :value "!"}]
                        :when-false {:type :text :value "Please log in"}}}]

         (parser/parse "deeply-nested-conditionals.txt"))))
...
(deftest test-for-loop-with-nested-everything
  (is (= [{:body       [{:type  :text
         ...
         (parser/parse "nested-for-loops.txt"))))
...
(deftest test-nested-property-expression
  ...
  (is (= [{:type :opening-bracket}
          {:type :expression :value [:user :profile :name]}
          {:type :closing-bracket}]
...
(deftest test-for-loop-with-nested-source
  ...
  (is (= [{:type :block-start}
          {:type :keyword-for}
          {:type :identifier :value :product}
          {:type :keyword-in}
          {:type :identifier :value [:category :products]}
          {:type :block-end}
          {:type :opening-bracket}
...
(deftest test-simple-if-statement
  ...
  (is (= [{:type :block-start}
          {:type :keyword-if}
          {:type :identifier :value [:user :is_active]}
          {:type :block-end}
...
(deftest test-if-else-statement
  ...
  (is (= [{:type :block-start}
          {:type :keyword-if}
          {:type :identifier :value [:user :is_premium]}
          {:type :block-end}
          {:type :text :value "Premium features enabled"}
          {:type :block-start}
          {:type :keyword-else}
          {:type :block-end}
          {:type :text :value "Upgrade to premium"}
          {:type :block-start}
          {:type :keyword-endif}
          {:type :block-end}]
...
(deftest test-nested-for-loops
  ...
  (is (= [{:type :block-start}
          ...
          {:type :keyword-in}
          {:type :identifier :value [:categories]}
          {:type :block-end}
          {:type :text :value "Category: "}
          {:type :opening-bracket}
          {:type :expression :value [:category :name]}
          {:type :closing-bracket}
          {:type :block-start}
          {:type :keyword-for}
          {:type :identifier :value :item}
          {:type :keyword-in}
          {:type :identifier :value [:category :items]}
          {:type :block-end}
          {:type :text :value "  - "}
          {:type :opening-bracket}
...
(deftest test-nested-if-statements
  ...
  (is (= [{:type :block-start}
          {:type :keyword-if}
          {:type :identifier :value [:user :is_logged_in]}
          {:type :block-end}
          {:type :text :value "Welcome "}
          {:type :opening-bracket}
          ...
          {:type :block-start}
          {:type :keyword-if}
          {:type :identifier :value [:user :has_notifications]}
          {:type :block-end}
          {:type :text :value "You have "}
          {:type :opening-bracket}
          {:type :expression :value [:user :notification_count]}
          {:type :closing-bracket}
          {:type :text :value " new messages."}
          {:type :block-start}
          {:type :keyword-else}
          {:type :block-end}
          {:type :text :value "No new messages."}
          {:type :block-start}
          {:type :keyword-endif}
          {:type :block-end}
          {:type :block-start}
...
(deftest test-for-loop-with-nested-if
  ...
  (is (= [{:type :block-start}
          ...
          {:type :block-start}
          {:type :keyword-if}
          {:type :identifier :value [:product :in_stock]}
          {:type :block-end}
...
(deftest test-multiline-template
  ...
  (is (= [{:type :text :value "Hello "}
          ...
          {:type :block-start}
          {:type :keyword-if}
          {:type :identifier :value [:show_details]}
          {:type :block-end}
          {:type :text :value "\n  Details: "}
          {:type :opening-bracket}
          {:type :expression :value [:details]}
          {:type :closing-bracket}
          {:type :block-start}
          {:type :keyword-endif}
          {:type :block-end}]
...
(deftest test-special-characters-in-text
  "Test lexing with special characters in regular text"
...
(deftest test-expressions-with-numbers-in-property-names
  "Test lexing expressions with numeric components in property names"
  (is (= [{:type :opening-bracket}
          {:type :expression :value [:user :address1 :street]}
          {:type :closing-bracket}]
